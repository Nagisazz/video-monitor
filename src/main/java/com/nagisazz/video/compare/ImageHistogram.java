package com.nagisazz.video.compare;
...
public class ImageHistogram {
	...
	public double match(InputStream srcFileStream, InputStream canFileStream) throws IOException {
		float[] sourceData = this.filter(ImageIO.read(srcFileStream));
		float[] candidateData = this.filter(ImageIO.read(canFileStream));
		return calcSimilarity(sourceData, candidateData);
	}
